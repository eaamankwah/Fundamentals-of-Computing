...
def norm(distr):
    ...
    return {degree: num / total for degree, num in distr.items()}
...
def main():
    ...
    question1(None, 'pic1-citation.png')
    plt.clf()
    question2(None, 'pic2-random.png')
    plt.clf()
    question3(None, 'pic3-dpa.png')
    ...
    question1(311)
    question2(312)
    question3(313, 'piccitation-random-dpa.png')

    # plot two graphs on a single plot and show it
    plt.clf()
    plt.cla()
    question1(211)
    question3(212, 'piccitation-dpa.png')
    plt.show()
