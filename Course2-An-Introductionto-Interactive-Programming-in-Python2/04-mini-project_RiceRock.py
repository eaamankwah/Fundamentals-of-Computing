...
def grp_grp_collide(group, other_group):
    colnum = 0
    for each in set(group):
...
def draw(canvas):
    global time, started, my_ships, lives, score, rock_group
...
process_sprite_group(rock_group, canvas)
    ...
    if group_collide(rock_group, my_ship):
        lives -= 1
    score += grp_grp_collide(missile_group, rock_group) * 10
...
def rock_spawner():
    ...
    # rock_pos at least 100 px away of my_ship
